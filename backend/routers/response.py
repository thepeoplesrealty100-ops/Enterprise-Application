...
try:
    ...
    # v3.0 Phase 5: the same Maya-Vigesimal step-up interlock
    # stage_payloads() attaches to offensive payloads, now attached to
    # real containment/remediation actions too -- see
    # _maybe_attach_maya_challenge() below.
